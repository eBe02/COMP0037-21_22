...
from grid_search.greedy_shortest_distance_rewiring_planner \
    import GreedyShortestDistanceRewiringPlanner
...
planner = GreedyShortestDistanceRewiringPlanner(occupancyGrid)
